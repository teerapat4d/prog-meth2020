...
public class Main {
	...
	public static boolean addDepartment(String newName) throws EmptyGuildNameException, DuplicateGuildNameException{
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		ArrayList<GuildMember> unassignedDepartment = myDatabase.removeDepartment(index);
		
		Department department = myDatabase.getDepartment(0);
		department.addMultipleMembers(unassignedDepartment);
